...
namespace disctape
{
    ...
    public sealed partial class SettingsPage : Page
    {
        ...
        {
            // local settings variable for storing the display unit value
            var localSettings = Windows.Storage.ApplicationData.Current.LocalSettings;
            RadioButton btn = (RadioButton)sender;
            string btn_txt = btn.Content.ToString();

            if (btn_txt == "Meters")
            {
                localSettings.Values["DisplayUnit"] = "METERS";
            }
            else if (btn_txt == "Feet")
            {
                localSettings.Values["DisplayUnit"] = "FEET";
            }
            else if (btn_txt == "Meters and Feet")
            {
                localSettings.Values["DisplayUnit"] = "METERES_AND_FEET";
            }
        }
    }
}